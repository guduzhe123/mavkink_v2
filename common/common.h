...
#include "./mavlink_msg_stm32_f3_command.h"
#include "./mavlink_msg_stm32_f3_motor_curr.h"
#include "./mavlink_msg_pid_auto_tune.h"
#include "./mavlink_msg_battery_status_2.h"
