...
static void mavlink_test_stm32_f3_command(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_stm32_f3_command_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_stm32_f3_command_pack(system_id, component_id, &msg , packet1.command , packet1.param , packet1.f3_log );
    mavlink_msg_stm32_f3_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_stm32_f3_command_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.command , packet1.param , packet1.f3_log );
    mavlink_msg_stm32_f3_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_stm32_f3_command_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_stm32_f3_command_send(MAVLINK_COMM_1 , packet1.command , packet1.param , packet1.f3_log );
    mavlink_msg_stm32_f3_command_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_pid_auto_tune(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_PID_AUTO_TUNE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_pid_auto_tune_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0
    };
    mavlink_pid_auto_tune_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.j_pid_tune = packet_in.j_pid_tune;
        packet1.e_rate = packet_in.e_rate;
        packet1.e_ang = packet_in.e_ang;
        packet1.control_u = packet_in.control_u;
        packet1.error_ang_bet = packet_in.error_ang_bet;
        packet1.ang_act = packet_in.ang_act;
        packet1.angle_sp = packet_in.angle_sp;
        packet1.ang_pre = packet_in.ang_pre;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_PID_AUTO_TUNE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_PID_AUTO_TUNE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_pid_auto_tune_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_pid_auto_tune_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_pid_auto_tune_pack(system_id, component_id, &msg , packet1.j_pid_tune , packet1.e_rate , packet1.e_ang , packet1.control_u , packet1.error_ang_bet , packet1.ang_act , packet1.angle_sp , packet1.ang_pre );
    mavlink_msg_pid_auto_tune_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_pid_auto_tune_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.j_pid_tune , packet1.e_rate , packet1.e_ang , packet1.control_u , packet1.error_ang_bet , packet1.ang_act , packet1.angle_sp , packet1.ang_pre );
    mavlink_msg_pid_auto_tune_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_pid_auto_tune_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_pid_auto_tune_send(MAVLINK_COMM_1 , packet1.j_pid_tune , packet1.e_rate , packet1.e_ang , packet1.control_u , packet1.error_ang_bet , packet1.ang_act , packet1.angle_sp , packet1.ang_pre );
    mavlink_msg_pid_auto_tune_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
